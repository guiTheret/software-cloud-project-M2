...
export default function CleanerBook() {
  ...
  return (
    ...
    >
      <Modal show={showModal} onHide={() => closeModal()}>
        ...
        <Modal.Body>
          {confirmModalMessage === "" ? (
            <div>
              <p>
                Are you sure to book {cleaner.firstName} {cleaner.lastName} ?
              </p>
      ...
      <div
        style={{ fontWeight: "bold", textAlign: "center", fontSize: "2rem" }}
      >
        Here are the next availabilities for {cleaner.firstName}{" "}
      </div>
      <div
        style={{ display: "flex", flexDirection: "row", alignItems: "center" }}
      >
        {selectedDate.toLocaleDateString("fr-FR") !==
          todayDate.toLocaleDateString("fr-FR") && (
          <Button
      ...
      <div>
        {cleanerDate.length === 0 ? (
          <div>
            No slot available for {cleaner.firstName} {cleaner.lastName}
          </div>
        ) : (
          <div
            style={{
                  ...
                  return (
                    <div
                      ...
                      style={{
                        padding: 10,
                        backgroundColor:
                          isSelected(date) === true ? "red" : "#0D6EFD",
                        margin: 5,
                        width: 100,
                        alignItems: "center",
                        height: 50,
